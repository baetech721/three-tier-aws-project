...
3. VPC association
4. Terraform filters
5. Whether the resource actually exists
...
bash sudo chown -R $(whoami):$(whoami) .
...
bash docker ps docker logs <container> ss -tulpn curl http://localhost:8000
...
bash docker pull <exact-ECR-image-URI>
...
- [x] Three-tier application structure
- [x] Frontend/Nginx tier
- [x] FastAPI backend
...
- [x] Amazon ECR
- [x] EC2 deployment
- [x] EC2 IAM role for ECR
- [x] GitHub OIDC
- [x] IAM trust-policy troubleshooting
- [x] CloudTrail-based OIDC debugging
- [x] Terraform
- [x] Terraform EC2 provisioning
- [x] Terraform data sources
- [x] Terraform plan/apply
- [x] Terraform through GitHub Actions
- [x] Terraform state moved toward S3
- [x] AWS troubleshooting practice
- [x] Monitoring stack planning
